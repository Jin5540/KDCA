...
public class MemberDAO {
	...
	{
		int result=-1; //-1 --> 1;
		String sql = "insert into Mkdca(name,userid,pwd,email,phone,admin,date) values(?,?,?,?,?,?,?)";
		Connection conn =null;
	...
	{
		int result=-1;
		String sql = "select * from Mkdca where userid=?";
		Connection conn=null;
		PreparedStatement pstmt =null;
		ResultSet rs=null;
	...
	public int updateMember(MemberVO mVo)
	{
		/*p511*/
		int result=-1;
		String sql = "update Mkdca set pwd=?,email=?,";
	...
	public int dropMember(String userid)
	{
		/*p511*/
		int result=-1;
		String sql = "delete from Mkdca where userid=?";
	...
	public int confirmID(String userid)
	{
		...
		/*p495*/
		int result=-1;
		String sql = "select userid from Mkdca where userid=?";
